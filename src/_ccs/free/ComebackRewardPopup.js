 ...
 *
 */
_ccs.ComebackRewardPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.ComebackRewardPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._txtHeader.setString(gm.localize.getText("TXT_WELCOME_BACK"));
        ...
        ck.UIUtils.setPositionPercent(this._glow, 0.4754, 0.4808);
        ...
        ck.UIUtils.setPositionPercent(this._txtMessage, 0.5, 0.8241);
        ...
        _txtMessageLayoutComponent.setPositionPercentY(0.8241);
        _txtMessageLayoutComponent.setPercentWidthEnabled(true);
        _txtMessageLayoutComponent.setPercentWidth(0.528);
        ...
        this._txtMessage.setString(gm.localize.getText("TXT_COMEBACK_GIFT_MESSAGE"));
        ...
        ck.UIUtils.setPositionPercent(this._imgButton, 0.5, 0.1683);
        ...
        _imgButtonLayoutComponent.setPositionPercentY(0.1683);
...
/**
 * Create ComebackRewardPopup
 * @returns {_ccs.ComebackRewardPopup}
 */
_ccs.ComebackRewardPopup.create = function () {
    return new _ccs.ComebackRewardPopup();
};
