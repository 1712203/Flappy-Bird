...
/**
 * _ccs.DailyRewardItemWidgetLogin30Normal
 *
 ...
 *
 */
_ccs.DailyRewardItemWidgetLogin30Normal = ccui.Widget.extend({
    ...
    /**
     * _ccs.DailyRewardItemWidgetLogin30Normal constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._root.setContentSize(cc.size(130, 205));
...
/**
 * Create DailyRewardItemWidgetLogin30Normal
 * @returns {_ccs.DailyRewardItemWidgetLogin30Normal}
 */
_ccs.DailyRewardItemWidgetLogin30Normal.create = function () {
    return new _ccs.DailyRewardItemWidgetLogin30Normal();
};
