 ...
 *
 */
_ccs.DailyGiftWidget2 = ccui.Widget.extend({
    ...
    /**
     * _ccs.DailyGiftWidget2 constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create DailyGiftWidget2
 * @returns {_ccs.DailyGiftWidget2}
 */
_ccs.DailyGiftWidget2.create = function () {
    return new _ccs.DailyGiftWidget2();
};
