 ...
 *
 */
_ccs.LeagueRewardWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.LeagueRewardWidget constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create LeagueRewardWidget
 * @returns {_ccs.LeagueRewardWidget}
 */
_ccs.LeagueRewardWidget.create = function () {
    return new _ccs.LeagueRewardWidget();
};
