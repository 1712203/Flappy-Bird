 ...
 *
 */
_ccs.LeagueIcon = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.56);
        this._imgIcon.setScale(0.55, 0.55);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.56);
        this._imgIcon.loadTexture("league/league_5.png", 1);
        this._imgIcon.setUnifySizeEnabled(false);
        this._imgIcon.ignoreContentAdaptWithSize(false);
        this._imgIcon.setContentSize(cc.size(219, 207));
        ...
        ck.UIUtils.setPositionPercent(this._imgRedDot, 0.9201, 0.9213);
        ...
        _imgRedDotLayoutComponent.setPositionPercentX(0.9201);
        _imgRedDotLayoutComponent.setPositionPercentYEnabled(true);
        _imgRedDotLayoutComponent.setPositionPercentY(0.9213);
...
/**
 * Create LeagueIcon
 * @returns {_ccs.LeagueIcon}
 */
_ccs.LeagueIcon.create = function () {
    return new _ccs.LeagueIcon();
};
