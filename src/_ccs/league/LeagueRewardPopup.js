 ...
 *
 */
_ccs.LeagueRewardPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.LeagueRewardPopup constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create LeagueRewardPopup
 * @returns {_ccs.LeagueRewardPopup}
 */
_ccs.LeagueRewardPopup.create = function () {
    return new _ccs.LeagueRewardPopup();
};
