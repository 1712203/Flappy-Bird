...
/**
 * _ccs.RankingPlayerRewardWidget
 *
 ...
 *
 */
_ccs.RankingPlayerRewardWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.RankingPlayerRewardWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._layoutRoot.setContentSize(cc.size(55, 55));
        ...
        ck.UIUtils.setPositionPercent(this._txtAmount, 0.5, 0.21);
        ...
        _txtAmountLayoutComponent.setPositionPercentY(0.21);
        ...
        this._txtAmount.enableOutline(cc.color(48, 10, 0, 255), 1);
...
/**
 * Create RankingPlayerRewardWidget
 * @returns {_ccs.RankingPlayerRewardWidget}
 */
_ccs.RankingPlayerRewardWidget.create = function () {
    return new _ccs.RankingPlayerRewardWidget();
};
