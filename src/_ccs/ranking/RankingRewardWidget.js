 ...
 *
 */
_ccs.RankingRewardWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.RankingRewardWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._txtAmount, 0.9305, 0.0193);
        ...
        _txtAmountLayoutComponent.setPositionPercentX(0.9305);
        _txtAmountLayoutComponent.setPositionPercentYEnabled(true);
        _txtAmountLayoutComponent.setPositionPercentY(0.0193);
        ...
        this._txtAmount.setDefaultFontSize(38);
...
/**
 * Create RankingRewardWidget
 * @returns {_ccs.RankingRewardWidget}
 */
_ccs.RankingRewardWidget.create = function () {
    return new _ccs.RankingRewardWidget();
};
