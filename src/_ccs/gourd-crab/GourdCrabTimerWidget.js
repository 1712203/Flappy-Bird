 ...
 *
 */
_ccs.GourdCrabTimerWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.GourdCrabTimerWidget constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create GourdCrabTimerWidget
 * @returns {_ccs.GourdCrabTimerWidget}
 */
_ccs.GourdCrabTimerWidget.create = function () {
    return new _ccs.GourdCrabTimerWidget();
};
