 ...
 *
 */
_ccs.GourdCrabButtonWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.GourdCrabButtonWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imageShadow.setColor(cc.color(153, 73, 184, 255));
        ...
        this._imgIcon.loadTexture("home/IconGourdCrab.png", 1);
        this._imgIcon.setUnifySizeEnabled(false);
        this._imgIcon.ignoreContentAdaptWithSize(false);
        this._imgIcon.setContentSize(cc.size(154, 131));
        ...
        this._imgText.loadTexture("texts/home/MiniGameGourdCrab.png", 1);
        ...
        this._txtText.setTextColor(cc.color(206, 153, 255, 255));
        ...
        this._txtText.setString("CAT & FISH");
        this._txtText.setTextHorizontalAlignment(0);
        this._txtText.setTextVerticalAlignment(0);
        this._txtText.enableOutline(cc.color(16, 3, 73, 255), 1);
...
/**
 * Create GourdCrabButtonWidget
 * @returns {_ccs.GourdCrabButtonWidget}
 */
_ccs.GourdCrabButtonWidget.create = function () {
    return new _ccs.GourdCrabButtonWidget();
};
