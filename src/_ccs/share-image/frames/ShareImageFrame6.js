 ...
 *
 */
_ccs.ShareImageFrame6 = cc.Layer.extend({
    ...
    /**
     * _ccs.ShareImageFrame6 constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgBackground.loadTexture("share-image/frames/Background_06.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgText, 0.0917, 0.9667);
        let _imgTextLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgText);
        this._imgText.loadTexture("texts/share-image/ShareImage_06.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._nodePhone, 0.13, 0.0633);
        ...
        this._imgBgrCode.setAnchorPoint(cc.p(1, 0));
        ck.UIUtils.setPositionPercent(this._imgBgrCode, 0.98, 0.16);
        ...
        _imgBgrCodeLayoutComponent.setPositionPercentX(0.98);
        _imgBgrCodeLayoutComponent.setPositionPercentYEnabled(true);
        _imgBgrCodeLayoutComponent.setPositionPercentY(0.16);
        _imgBgrCodeLayoutComponent.setPercentWidthEnabled(true);
        _imgBgrCodeLayoutComponent.setPercentWidth(0.4217);
        this._imgBgrCode.loadTexture("basics2/other/Box_03.png", 1);
        this._imgBgrCode.setUnifySizeEnabled(false);
        this._imgBgrCode.ignoreContentAdaptWithSize(false);
        ck.UIUtils.setWidthPercent(this._imgBgrCode, 0.4217);
        this._imgBgrCode.setContentSize(cc.size(this._imgBgrCode.width, 178));
        ...
        ck.UIUtils.setPositionPercent(this._txtTitle, 0.5, 0.8);
        ...
        _txtTitleLayoutComponent.setPositionPercentY(0.8);
        ...
        this._txtTitle.setContentSize(cc.size(200, 36));
        ...
        ck.UIUtils.setPositionPercent(this._txtCode, 0.5, 0.475);
        this._txtCode.setTextColor(cc.color(255, 221, 63, 255));
        ...
        ck.UIUtils.setPositionPercent(this._txtExpireTime, 0.5, 0.2);
        this._txtExpireTime.setTextColor(cc.color(63, 190, 255, 255));
        ...
        _txtExpireTimeLayoutComponent.setPositionPercentY(0.2);
        ...
        this._txtExpireTime.setContentSize(cc.size(200, 22));
        this._txtExpireTime.setFontName("fonts/BebasNeueProBold.ttf");
        this._txtExpireTime.setDefaultFontSize(20);
        ...
        ck.UIUtils.setPositionPercent(this._imgAppIconSearchBar, 0.9491, 0.05);
        ...
        _imgAppIconSearchBarLayoutComponent.setPositionPercentXEnabled(true);
        _imgAppIconSearchBarLayoutComponent.setPositionPercentX(0.9491);
        _imgAppIconSearchBarLayoutComponent.setPositionPercentYEnabled(true);
        _imgAppIconSearchBarLayoutComponent.setPositionPercentY(0.05);
...
/**
 * Create ShareImageFrame6
 * @returns {_ccs.ShareImageFrame6}
 */
_ccs.ShareImageFrame6.create = function () {
    return new _ccs.ShareImageFrame6();
};
