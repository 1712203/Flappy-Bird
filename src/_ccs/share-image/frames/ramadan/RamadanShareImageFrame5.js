 ...
 *
 */
_ccs.RamadanShareImageFrame5 = cc.Layer.extend({
    ...
    /**
     * _ccs.RamadanShareImageFrame5 constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgBackground.loadTexture("share-image/frames/ramadan/Background_05.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgText, 0.0167, 0.85);
        let _imgTextLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgText);
        this._imgText.loadTexture("texts/share-image/ramadan/ShareImage_05.png", 1);
...
/**
 * Create RamadanShareImageFrame5
 * @returns {_ccs.RamadanShareImageFrame5}
 */
_ccs.RamadanShareImageFrame5.create = function () {
    return new _ccs.RamadanShareImageFrame5();
};
