 ...
 *
 */
_ccs.RamadanShareImageFrame4 = cc.Layer.extend({
    ...
    /**
     * _ccs.RamadanShareImageFrame4 constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgBackground.loadTexture("share-image/frames/ramadan/Background_04.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgText, 0.05, 0.85);
        let _imgTextLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgText);
        this._imgText.loadTexture("texts/share-image/ramadan/ShareImage_04.png", 1);
...
/**
 * Create RamadanShareImageFrame4
 * @returns {_ccs.RamadanShareImageFrame4}
 */
_ccs.RamadanShareImageFrame4.create = function () {
    return new _ccs.RamadanShareImageFrame4();
};
