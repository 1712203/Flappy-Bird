 ...
 *
 */
_ccs.RamadanShareImageFrame2 = cc.Layer.extend({
    ...
    /**
     * _ccs.RamadanShareImageFrame2 constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgBackground.loadTexture("share-image/frames/ramadan/Background_02.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgText, 0.0167, 0.8717);
        let _imgTextLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgText);
        this._imgText.loadTexture("texts/share-image/ramadan/ShareImage_02.png", 1);
...
/**
 * Create RamadanShareImageFrame2
 * @returns {_ccs.RamadanShareImageFrame2}
 */
_ccs.RamadanShareImageFrame2.create = function () {
    return new _ccs.RamadanShareImageFrame2();
};
