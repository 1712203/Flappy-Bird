 ...
 *
 */
_ccs.RamadanShareImageFrame1 = cc.Layer.extend({
    ...
    /**
     * _ccs.RamadanShareImageFrame1 constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgBackground.loadTexture("share-image/frames/ramadan/Background_01.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgText, 0.0533, 0.8717);
        let _imgTextLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgText);
        this._imgText.loadTexture("texts/share-image/ramadan/ShareImage_01.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgBgrCode, 0.2683, 0.025);
        ...
        _imgBgrCodeLayoutComponent.setPositionPercentX(0.2683);
...
/**
 * Create RamadanShareImageFrame1
 * @returns {_ccs.RamadanShareImageFrame1}
 */
_ccs.RamadanShareImageFrame1.create = function () {
    return new _ccs.RamadanShareImageFrame1();
};
