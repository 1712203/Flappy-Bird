 ...
 *
 */
_ccs.CardFlipButtonWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.CardFlipButtonWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imageShadow.setColor(cc.color(190, 75, 77, 255));
        ...
        this._imgIcon.setScale(0.72, 0.72);
        ...
        this._imgIcon.loadTexture("home/IconFlipCard.png", 1);
        this._imgIcon.setUnifySizeEnabled(false);
        this._imgIcon.ignoreContentAdaptWithSize(false);
        this._imgIcon.setContentSize(cc.size(182, 145));
        ...
        this._imgText.loadTexture("texts/home/MiniGameFlipCards.png", 1);
        ...
        this._txtText.setTextColor(cc.color(226, 133, 129, 255));
        ...
        this._txtText.setString("FLIP CARDS");
        this._txtText.setTextHorizontalAlignment(0);
        this._txtText.setTextVerticalAlignment(0);
        this._txtText.enableOutline(cc.color(73, 29, 3, 255), 1);
...
/**
 * Create CardFlipButtonWidget
 * @returns {_ccs.CardFlipButtonWidget}
 */
_ccs.CardFlipButtonWidget.create = function () {
    return new _ccs.CardFlipButtonWidget();
};
