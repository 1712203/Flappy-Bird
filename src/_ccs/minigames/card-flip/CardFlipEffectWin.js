 ...
 *
 */
_ccs.CardFlipEffectWin = ccui.Widget.extend({
    ...
    /**
     * _ccs.CardFlipEffectWin constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create CardFlipEffectWin
 * @returns {_ccs.CardFlipEffectWin}
 */
_ccs.CardFlipEffectWin.create = function () {
    return new _ccs.CardFlipEffectWin();
};
