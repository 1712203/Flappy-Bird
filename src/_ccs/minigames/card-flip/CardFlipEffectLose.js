 ...
 *
 */
_ccs.CardFlipEffectLose = ccui.Widget.extend({
    ...
    /**
     * _ccs.CardFlipEffectLose constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create CardFlipEffectLose
 * @returns {_ccs.CardFlipEffectLose}
 */
_ccs.CardFlipEffectLose.create = function () {
    return new _ccs.CardFlipEffectLose();
};
