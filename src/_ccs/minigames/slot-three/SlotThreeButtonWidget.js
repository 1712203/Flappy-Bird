 ...
 *
 */
_ccs.SlotThreeButtonWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.SlotThreeButtonWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imageShadow.setColor(cc.color(189, 115, 0, 255));
        ...
        ck.UIUtils.setPositionPercent(this._layoutIcon, 0.5, 0.5394);
        ...
        this._imgIcon.setScale(0.59, 0.59);
        ...
        this._imgIcon.loadTexture("home/IconSlotMachine.png", 1);
        this._imgIcon.setUnifySizeEnabled(false);
        this._imgIcon.ignoreContentAdaptWithSize(false);
        this._imgIcon.setContentSize(cc.size(207, 191));
        ...
        this._imgText.loadTexture("texts/home/MiniGameSlotMachine.png", 1);
        ...
        this._txtText.setTextColor(cc.color(255, 206, 23, 255));
        ...
        this._txtText.setString("JACKPOT SPIN");
        this._txtText.setTextHorizontalAlignment(0);
        this._txtText.setTextVerticalAlignment(0);
        this._txtText.enableOutline(cc.color(67, 40, 14, 255), 1);
    ...
    resetCCSAnimNoBackground: function () {
        ...
        this._layoutIcon.setPosition(82.5, 89);
...
/**
 * Create SlotThreeButtonWidget
 * @returns {_ccs.SlotThreeButtonWidget}
 */
_ccs.SlotThreeButtonWidget.create = function () {
    return new _ccs.SlotThreeButtonWidget();
};
