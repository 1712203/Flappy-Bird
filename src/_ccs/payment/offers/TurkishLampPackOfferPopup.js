...
/**
 * _ccs.TurkishLampPackOfferPopup
 *
 ...
 *
 */
_ccs.TurkishLampPackOfferPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.TurkishLampPackOfferPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._root.setPosition(-0.0013, -0.0018);
        let _rootLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._root);
        this._root.setTouchEnabled(true);
        this._root.setUnifySizeEnabled(false);
        this._root.ignoreContentAdaptWithSize(false);
        this._root.setContentSize(cc.size(640, 1011.7668));
        ...
        this._imgTitle.setAnchorPoint(cc.p(1, 0.5));
        ck.UIUtils.setPositionPercent(this._imgTitle, 0.8438, 0.9083);
        ...
        _imgTitleLayoutComponent.setPositionPercentX(0.8438);
        this._imgTitle.loadTexture("texts/offers/TurkishLampPack.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgClose, 0.9094, 0.8371);
        ...
        ck.UIUtils.setPositionPercent(this._imgBackgroundLayoutItems, 0.9472, 0.7577);
        ...
        _imgBackgroundLayoutItemsLayoutComponent.setPositionPercentX(0.9472);
        this._imgBackgroundLayoutItems.loadTexture("offers/musical-turkey/BackgroundItems.png", 1);
        this._imgBackgroundLayoutItems.setUnifySizeEnabled(false);
        this._imgBackgroundLayoutItems.ignoreContentAdaptWithSize(false);
        this._imgBackgroundLayoutItems.setContentSize(cc.size(419, 373));
        ...
        ck.UIUtils.setPositionPercent(this._imgBonus, 0.1136, 0.7627);
        this._imgBonus.setScale(0.65, 0.65);
        this._imgBonus.setRotationX(-14.9954);
        ...
        ck.UIUtils.setPositionPercent(this._layoutItems, 0.9472, 0.7577);
        ...
        _layoutItemsLayoutComponent.setPositionPercentX(0.9472);
        ...
        this._layoutItems.setContentSize(cc.size(419, 373));
        ...
        ck.UIUtils.setPositionPercent(this._nodeMainItem, 0.5564, 0.8165);
        ...
        _nodeMainItemLayoutComponent.setPositionPercentX(0.5564);
        _nodeMainItemLayoutComponent.setPositionPercentYEnabled(true);
        _nodeMainItemLayoutComponent.setPositionPercentY(0.8165);
        ...
        this._imgBackgroundMainItem.setContentSize(cc.size(350, 72.3464));
        ...
        this._txtAmountMainItem.setPosition(41.321, 0);
        ...
        this._txtAmountMainItem.setDefaultFontSize(45);
        ...
        ck.UIUtils.setPositionPercent(this._gridItems, 0.6089, 0.3826);
        ...
        _gridItemsLayoutComponent.setPositionPercentX(0.6089);
        _gridItemsLayoutComponent.setPositionPercentYEnabled(true);
        _gridItemsLayoutComponent.setPositionPercentY(0.3826);
        _gridItemsLayoutComponent.setPercentWidthEnabled(true);
        _gridItemsLayoutComponent.setPercentWidth(0.746);
        ...
        ck.UIUtils.setPositionPercent(this._txtTimeLeft, 0.3994, 0.7799);
        ...
        _txtTimeLeftLayoutComponent.setPositionPercentX(0.3994);
        ...
        this._txtTimeLeft.enableOutline(cc.color(135, 81, 168, 255), 1);
        this._txtTimeLeft.enableShadow(cc.color(135, 81, 168, 255), cc.size(0, -1), 0);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint01, 0.5, 0.2263);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint02, 0.5, -0.004);
        ...
        ck.UIUtils.setPositionPercent(this._imgBuy, 0.5, 0.1297);
        ...
        ck.UIUtils.setPositionPercent(this._layoutBonusItems, 0.6791, 0.3843);
        ...
        _layoutBonusItemsLayoutComponent.setPositionPercentX(0.6791);
        _layoutBonusItemsLayoutComponent.setPositionPercentYEnabled(true);
        _layoutBonusItemsLayoutComponent.setPositionPercentY(0.3843);
        ...
        ck.UIUtils.setPositionPercent(this._gridBonusItems, 0.5018, 0.5);
        ...
        ck.UIUtils.setPositionPercent(this._imgPlus, 0.6824, 0.3837);
        ...
        _imgPlusLayoutComponent.setPositionPercentX(0.6824);
        _imgPlusLayoutComponent.setPositionPercentYEnabled(true);
        _imgPlusLayoutComponent.setPositionPercentY(0.3837);
        ...
        ck.UIUtils.setPositionPercent(this._btnChannels, 0.5, 0.0422);
        ...
        _btnChannelsLayoutComponent.setPositionPercentY(0.0422);
...
/**
 * Create TurkishLampPackOfferPopup
 * @returns {_ccs.TurkishLampPackOfferPopup}
 */
_ccs.TurkishLampPackOfferPopup.create = function () {
    return new _ccs.TurkishLampPackOfferPopup();
};
