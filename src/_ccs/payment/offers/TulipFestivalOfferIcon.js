 ...
 *
 */
_ccs.TulipFestivalOfferIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.TulipFestivalOfferIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.52, 0.5661);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.5661);
        this._imgIcon.loadTexture("offers/tulip-festival/Icon.png", 1);
...
/**
 * Create TulipFestivalOfferIcon
 * @returns {_ccs.TulipFestivalOfferIcon}
 */
_ccs.TulipFestivalOfferIcon.create = function () {
    return new _ccs.TulipFestivalOfferIcon();
};
