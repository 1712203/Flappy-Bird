 ...
 *
 */
_ccs.RamadanGiftOfferPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.RamadanGiftOfferPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgTitle, 0.53, 1.0293);
        ...
        _imgTitleLayoutComponent.setPositionPercentX(0.53);
        this._imgTitle.loadTexture("texts/offers/RamadanGift.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgBonus, 0.1953, 0.2157);
        ...
        ck.UIUtils.setPositionPercent(this._layoutItems, 0.6359, 0.5794);
        ...
        this._layoutItems.setContentSize(cc.size(390, 390));
        ...
        ck.UIUtils.setPositionPercent(this._nodeMainItem, 0.5, 0.82);
        ...
        _nodeMainItemLayoutComponent.setPositionPercentY(0.82);
        ...
        this._imgBackgroundMainItem.setColor(cc.color(2, 66, 123, 255));
        ...
        this._txtAmountMainItem.setDefaultFontSize(46);
        ...
        ck.UIUtils.setPositionPercent(this._imgIconMainItem, -0.0112, 0.5);
        ...
        ck.UIUtils.setPositionPercent(this._gridItems, 0.5, 0.3526);
        ...
        _gridItemsLayoutComponent.setPositionPercentY(0.3526);
        ...
        ck.UIUtils.setPositionPercent(this._txtTimeLeft, 0.8178, 0.948);
        ...
        _txtTimeLeftLayoutComponent.setPositionPercentX(0.8178);
        ...
        this._txtTimeLeft.enableOutline(cc.color(39, 59, 156, 255), 1);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint01, 0.5, 0.1257);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint02, 0.5, -0.1566);
        ...
        ck.UIUtils.setPositionPercent(this._imgBuy, 0.5, 0.0085);
        ...
        _imgBuyLayoutComponent.setPositionPercentY(0.0085);
        ...
        ck.UIUtils.setPositionPercent(this._imgClose, 0.9031, 0.9283);
        ...
        ck.UIUtils.setPositionPercent(this._layoutBonusItems, 0.6545, 0.3354);
        ...
        _layoutBonusItemsLayoutComponent.setPositionPercentX(0.6545);
        _layoutBonusItemsLayoutComponent.setPositionPercentYEnabled(true);
        _layoutBonusItemsLayoutComponent.setPositionPercentY(0.3354);
        ...
        ck.UIUtils.setPositionPercent(this._imgPlus, 0.6637, 0.3289);
        ...
        _imgPlusLayoutComponent.setPositionPercentX(0.6637);
        _imgPlusLayoutComponent.setPositionPercentYEnabled(true);
        _imgPlusLayoutComponent.setPositionPercentY(0.3289);
        ...
        ck.UIUtils.setPositionPercent(this._btnChannels, 0.5, -0.1);
        ...
        _btnChannelsLayoutComponent.setPositionPercentY(-0.1);
...
/**
 * Create RamadanGiftOfferPopup
 * @returns {_ccs.RamadanGiftOfferPopup}
 */
_ccs.RamadanGiftOfferPopup.create = function () {
    return new _ccs.RamadanGiftOfferPopup();
};
