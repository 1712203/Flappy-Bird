 ...
 *
 */
_ccs.TurkeyIceCreamOfferPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.TurkeyIceCreamOfferPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgBackgroundLayoutItems.loadTexture("offers/turkey-ice-cream/BackgroundItems.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgBanner, 0.2734, 0.55);
        this._imgBanner.setScale(0.9, 0.9);
        let _imgBannerLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgBanner);
        this._imgBanner.loadTexture("offers/turkey-ice-cream/Banner.png", 1);
        this._imgBanner.setUnifySizeEnabled(false);
        this._imgBanner.ignoreContentAdaptWithSize(false);
        this._imgBanner.setContentSize(cc.size(370, 438));
        ...
        ck.UIUtils.setPositionPercent(this._imgTitle, 0.47, 0.9098);
        ...
        _imgTitleLayoutComponent.setPositionPercentX(0.47);
        this._imgTitle.loadTexture("texts/offers/TurkeyIceCream.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgBonus, 0.3203, 0.7237);
        this._imgBonus.setScale(0.6, 0.6);
        this._imgBonus.setRotationX(-14.9936);
        this._imgBonus.setRotationY(-14.9982);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint01, 0.5, 0.1995);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint02, 0.5, -0.0269);
        ...
        ck.UIUtils.setPositionPercent(this._imgBuy, 0.5, 0.1088);
        ...
        _imgBuyLayoutComponent.setPositionPercentY(0.1088);
        ...
        ck.UIUtils.setPositionPercent(this._btnChannels, 0.5, 0.0193);
        ...
        _btnChannelsLayoutComponent.setPositionPercentY(0.0193);
...
/**
 * Create TurkeyIceCreamOfferPopup
 * @returns {_ccs.TurkeyIceCreamOfferPopup}
 */
_ccs.TurkeyIceCreamOfferPopup.create = function () {
    return new _ccs.TurkeyIceCreamOfferPopup();
};
