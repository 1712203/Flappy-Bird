...
/**
 * _ccs.MysteriousVanCatOfferIcon
 *
 ...
 *
 */
_ccs.MysteriousVanCatOfferIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.MysteriousVanCatOfferIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.4884, 0.5638);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.5638);
        this._imgIcon.loadTexture("offers/mysterious-van-cat/Icon.png", 1);
...
/**
 * Create MysteriousVanCatOfferIcon
 * @returns {_ccs.MysteriousVanCatOfferIcon}
 */
_ccs.MysteriousVanCatOfferIcon.create = function () {
    return new _ccs.MysteriousVanCatOfferIcon();
};
