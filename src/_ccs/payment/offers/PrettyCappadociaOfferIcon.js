...
/**
 * _ccs.PrettyCappadociaOfferIcon
 *
 ...
 *
 */
_ccs.PrettyCappadociaOfferIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.PrettyCappadociaOfferIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.5532);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.5532);
        this._imgIcon.loadTexture("offers/pretty-camppadocia/Icon.png", 1);
        this._imgIcon.setUnifySizeEnabled(false);
        this._imgIcon.ignoreContentAdaptWithSize(false);
        this._imgIcon.setContentSize(cc.size(95, 95));
...
/**
 * Create PrettyCappadociaOfferIcon
 * @returns {_ccs.PrettyCappadociaOfferIcon}
 */
_ccs.PrettyCappadociaOfferIcon.create = function () {
    return new _ccs.PrettyCappadociaOfferIcon();
};
