...
/**
 * _ccs.MysteriousVanCatOfferPopup
 *
 ...
 *
 */
_ccs.MysteriousVanCatOfferPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.MysteriousVanCatOfferPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._root.setPosition(-0.0021, -0.0018);
        let _rootLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._root);
        this._root.setTouchEnabled(true);
        this._root.setUnifySizeEnabled(false);
        this._root.ignoreContentAdaptWithSize(false);
        this._root.setContentSize(cc.size(640, 1045.7841));
        ...
        ck.UIUtils.setPositionPercent(this._imgTitle, 0.525, 0.8788);
        let _imgTitleLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgTitle);
        this._imgTitle.loadTexture("texts/offers/MysteriousVanCat.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgClose, 0.9078, 0.9122);
        ...
        ck.UIUtils.setPositionPercent(this._imgBackgroundLayoutItems, 0.9914, 0.7241);
        ...
        this._imgBackgroundLayoutItems.loadTexture("offers/mysterious-van-cat/BackgroundItems.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgBonus, 0.3969, 0.5135);
        ...
        ck.UIUtils.setPositionPercent(this._layoutItems, 0.9914, 0.7241);
        ...
        ck.UIUtils.setPositionPercent(this._gridItems, 0.6238, 0.4146);
        ...
        _gridItemsLayoutComponent.setPositionPercentY(0.4146);
        ...
        ck.UIUtils.setPositionPercent(this._txtTimeLeft, 0.9677, 0.7564);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint01, 0.5, 0.1922);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint02, 0.5, -0.0229);
        ...
        ck.UIUtils.setPositionPercent(this._imgBuy, 0.5, 0.1063);
        ...
        _imgBuyLayoutComponent.setPositionPercentY(0.1063);
        ...
        ck.UIUtils.setPositionPercent(this._layoutBonusItems, 0.7001, 0.3442);
        ...
        _layoutBonusItemsLayoutComponent.setPositionPercentX(0.7001);
        _layoutBonusItemsLayoutComponent.setPositionPercentYEnabled(true);
        _layoutBonusItemsLayoutComponent.setPositionPercentY(0.3442);
        ...
        ck.UIUtils.setPositionPercent(this._imgPlus, 0.7001, 0.3537);
        ...
        _imgPlusLayoutComponent.setPositionPercentX(0.7001);
        _imgPlusLayoutComponent.setPositionPercentYEnabled(true);
        _imgPlusLayoutComponent.setPositionPercentY(0.3537);
...
/**
 * Create MysteriousVanCatOfferPopup
 * @returns {_ccs.MysteriousVanCatOfferPopup}
 */
_ccs.MysteriousVanCatOfferPopup.create = function () {
    return new _ccs.MysteriousVanCatOfferPopup();
};
