 ...
 *
 */
_ccs.MusicalTurkeyOfferIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.MusicalTurkeyOfferIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.471, 0.5232);
        ...
        _imgIconLayoutComponent.setPositionPercentX(0.471);
        _imgIconLayoutComponent.setPositionPercentYEnabled(true);
        _imgIconLayoutComponent.setPositionPercentY(0.5232);
        this._imgIcon.loadTexture("offers/musical-turkey/Icon.png", 1);
...
/**
 * Create MusicalTurkeyOfferIcon
 * @returns {_ccs.MusicalTurkeyOfferIcon}
 */
_ccs.MusicalTurkeyOfferIcon.create = function () {
    return new _ccs.MusicalTurkeyOfferIcon();
};
