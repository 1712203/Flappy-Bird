...
/**
 * _ccs.PrettyCappadociaOfferPopup
 *
 ...
 *
 */
_ccs.PrettyCappadociaOfferPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.PrettyCappadociaOfferPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._root.setPosition(-0.0017, -0.0018);
        let _rootLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._root);
        this._root.setTouchEnabled(true);
        this._root.setUnifySizeEnabled(false);
        this._root.ignoreContentAdaptWithSize(false);
        this._root.setContentSize(cc.size(640, 811.1924));
        ...
        ck.UIUtils.setPositionPercent(this._imgTitle, 0.5, 0.948);
        ...
        this._imgTitle.loadTexture("texts/offers/PrettyCappadocia.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgClose, 0.9078, 0.8395);
        ...
        ck.UIUtils.setPositionPercent(this._imgBonus, 0.1094, 0.8259);
        this._imgBonus.setScale(0.8, 0.8);
        this._imgBonus.setRotation(-15);
        ...
        this._layoutItems.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._layoutItems, 0.5, 0.6127);
        ...
        _layoutItemsLayoutComponent.setPositionPercentX(0.5);
        ...
        this._layoutItems.setContentSize(cc.size(426, 338));
        ...
        this._layoutItems.addChild(this._imgBackgroundLayoutItems);
        this._imgBackgroundLayoutItems.setCascadeOpacityEnabled(true);
        this._imgBackgroundLayoutItems.setCascadeColorEnabled(true);
        this._imgBackgroundLayoutItems.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._imgBackgroundLayoutItems, 0.5, 0.5);
        ...
        _imgBackgroundLayoutItemsLayoutComponent.setPositionPercentX(0.5);
        _imgBackgroundLayoutItemsLayoutComponent.setPositionPercentYEnabled(true);
        _imgBackgroundLayoutItemsLayoutComponent.setPositionPercentY(0.5);
        _imgBackgroundLayoutItemsLayoutComponent.setPercentWidthEnabled(true);
        _imgBackgroundLayoutItemsLayoutComponent.setPercentWidth(1);
        _imgBackgroundLayoutItemsLayoutComponent.setPercentHeightEnabled(true);
        _imgBackgroundLayoutItemsLayoutComponent.setPercentHeight(1);
        this._imgBackgroundLayoutItems.loadTexture("offers/pretty-camppadocia/BackgroundItems.png", 1);
        this._imgBackgroundLayoutItems.setUnifySizeEnabled(false);
        this._imgBackgroundLayoutItems.ignoreContentAdaptWithSize(false);
        ck.UIUtils.setSizePercent(this._imgBackgroundLayoutItems, 1, 1);
        ...
        ck.UIUtils.setPositionPercent(this._nodeMainItem, 0.5, 0.85);
        ...
        _nodeMainItemLayoutComponent.setPositionPercentX(0.5);
        _nodeMainItemLayoutComponent.setPositionPercentYEnabled(true);
        _nodeMainItemLayoutComponent.setPositionPercentY(0.85);
        ...
        this._txtAmountMainItem.setPosition(30, 0);
        ...
        this._txtAmountMainItem.setDefaultFontSize(50);
        ...
        this._txtAmountMainItem.enableShadow(cc.color(163, 56, 23, 255), cc.size(0, -5), 0);
        ...
        this._imgIconMainItem.setContentSize(cc.size(72, 72));
        ...
        ck.UIUtils.setPositionPercent(this._gridItems, 0.5, 0.3846);
        ...
        _gridItemsLayoutComponent.setPositionPercentY(0.3846);
        _gridItemsLayoutComponent.setPercentWidthEnabled(true);
        _gridItemsLayoutComponent.setPercentWidth(1);
        ...
        ck.UIUtils.setPositionPercent(this._txtTimeLeft, 0.5, 0.858);
        ...
        this._txtTimeLeft.enableOutline(cc.color(151, 76, 39, 255), 1);
        this._txtTimeLeft.enableShadow(cc.color(151, 76, 39, 255), cc.size(0, -1), 0);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint01, 0.5, 0.1874);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint02, 0.5, -0.0801);
        ...
        ck.UIUtils.setPositionPercent(this._imgBuy, 0.5, 0.0829);
        ...
        _imgBuyLayoutComponent.setPositionPercentY(0.0829);
        ...
        this._layoutBonusItems.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._layoutBonusItems, 0.4987, 0.3236);
        ...
        _layoutBonusItemsLayoutComponent.setPositionPercentX(0.4987);
        _layoutBonusItemsLayoutComponent.setPositionPercentYEnabled(true);
        _layoutBonusItemsLayoutComponent.setPositionPercentY(0.3236);
        ...
        ck.UIUtils.setPositionPercent(this._imgPlus, 0.4993, 0.3966);
        ...
        _imgPlusLayoutComponent.setPositionPercentX(0.4993);
        _imgPlusLayoutComponent.setPositionPercentYEnabled(true);
        _imgPlusLayoutComponent.setPositionPercentY(0.3966);
        ...
        ck.UIUtils.setPositionPercent(this._btnChannels, 0.5, -0.02);
        ...
        _btnChannelsLayoutComponent.setPositionPercentY(-0.02);
...
/**
 * Create PrettyCappadociaOfferPopup
 * @returns {_ccs.PrettyCappadociaOfferPopup}
 */
_ccs.PrettyCappadociaOfferPopup.create = function () {
    return new _ccs.PrettyCappadociaOfferPopup();
};
