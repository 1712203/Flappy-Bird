 ...
 *
 */
_ccs.MusicalTurkeyOfferPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.MusicalTurkeyOfferPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgTitle, 0.5656, 0.9998);
        let _imgTitleLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgTitle);
        this._imgTitle.loadTexture("texts/offers/MusicalTurkey.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._imgClose, 0.9172, 1.0552);
        ...
        ck.UIUtils.setPositionPercent(this._imgBackgroundLayoutItems, 0.9914, 0.7958);
        ...
        _imgBackgroundLayoutItemsLayoutComponent.setPositionPercentY(0.7958);
        ...
        this._imgBackgroundLayoutItems.setContentSize(cc.size(438, 388));
        ...
        ck.UIUtils.setPositionPercent(this._imgBonus, 0.3375, 0.7557);
        ...
        ck.UIUtils.setPositionPercent(this._layoutItems, 0.9914, 0.7958);
        ...
        _layoutItemsLayoutComponent.setPositionPercentYEnabled(true);
        _layoutItemsLayoutComponent.setPositionPercentY(0.7958);
        ...
        this._layoutItems.setContentSize(cc.size(438, 388));
        ...
        ck.UIUtils.setPositionPercent(this._nodeMainItem, 0.5755, 0.8019);
        ...
        _nodeMainItemLayoutComponent.setPositionPercentX(0.5755);
        ...
        ck.UIUtils.setPositionPercent(this._gridItems, 0.6238, 0.3946);
        ...
        _gridItemsLayoutComponent.setPositionPercentY(0.3946);
        ...
        ck.UIUtils.setPositionPercent(this._txtTimeLeft, 0.41, 0.8358);
        ...
        _txtTimeLeftLayoutComponent.setPositionPercentX(0.41);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint01, 0.5, 0.1048);
        ...
        ck.UIUtils.setPositionPercent(this._txtHint02, 0.5, -0.1726);
        ...
        ck.UIUtils.setPositionPercent(this._imgBuy, 0.5, -0.0056);
        ...
        _imgBuyLayoutComponent.setPositionPercentY(-0.0056);
        ...
        ck.UIUtils.setPositionPercent(this._layoutBonusItems, 0.6954, 0.3069);
        ...
        _layoutBonusItemsLayoutComponent.setPositionPercentX(0.6954);
        _layoutBonusItemsLayoutComponent.setPositionPercentYEnabled(true);
        _layoutBonusItemsLayoutComponent.setPositionPercentY(0.3069);
        ...
        ck.UIUtils.setPositionPercent(this._imgPlus, 0.7209, 0.3167);
        this._imgPlus.setScale(0.8, 0.8);
        ...
        _imgPlusLayoutComponent.setPositionPercentX(0.7209);
        _imgPlusLayoutComponent.setPositionPercentYEnabled(true);
        _imgPlusLayoutComponent.setPositionPercentY(0.3167);
        ...
        ck.UIUtils.setPositionPercent(this._btnChannels, 0.5, -0.1127);
        ...
        _btnChannelsLayoutComponent.setPositionPercentY(-0.1127);
...
/**
 * Create MusicalTurkeyOfferPopup
 * @returns {_ccs.MusicalTurkeyOfferPopup}
 */
_ccs.MusicalTurkeyOfferPopup.create = function () {
    return new _ccs.MusicalTurkeyOfferPopup();
};
