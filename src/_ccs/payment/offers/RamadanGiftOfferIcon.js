 ...
 *
 */
_ccs.RamadanGiftOfferIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.RamadanGiftOfferIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.6228);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.6228);
        this._imgIcon.loadTexture("offers/ramadan-gift/Icon.png", 1);
...
/**
 * Create RamadanGiftOfferIcon
 * @returns {_ccs.RamadanGiftOfferIcon}
 */
_ccs.RamadanGiftOfferIcon.create = function () {
    return new _ccs.RamadanGiftOfferIcon();
};
