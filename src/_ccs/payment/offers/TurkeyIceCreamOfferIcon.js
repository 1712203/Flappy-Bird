 ...
 *
 */
_ccs.TurkeyIceCreamOfferIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.TurkeyIceCreamOfferIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.52, 0.6161);
        ...
        _imgIconLayoutComponent.setPositionPercentX(0.52);
        _imgIconLayoutComponent.setPositionPercentYEnabled(true);
        _imgIconLayoutComponent.setPositionPercentY(0.6161);
        this._imgIcon.loadTexture("offers/turkey-ice-cream/Icon.png", 1);
...
/**
 * Create TurkeyIceCreamOfferIcon
 * @returns {_ccs.TurkeyIceCreamOfferIcon}
 */
_ccs.TurkeyIceCreamOfferIcon.create = function () {
    return new _ccs.TurkeyIceCreamOfferIcon();
};
