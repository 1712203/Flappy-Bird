 ...
 *
 */
_ccs.PaymentSuccessPopup = cc.Layer.extend({
    ...
    /**
     * _ccs.PaymentSuccessPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ///// # _nodeReward
        this._nodeReward = new cc.Node();
        this._nodeReward.setName("_nodeReward");
        this._layoutContent.addChild(this._nodeReward);
        this._nodeReward.setCascadeOpacityEnabled(true);
        this._nodeReward.setCascadeColorEnabled(true);
        ck.UIUtils.setPositionPercent(this._nodeReward, 0.48, 0.4078);
        let _nodeRewardLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._nodeReward);
        _nodeRewardLayoutComponent.setPositionPercentXEnabled(true);
        _nodeRewardLayoutComponent.setPositionPercentX(0.48);

        ///// # _txtRewardAmount
        this._txtRewardAmount = new ck.Text();
        this._txtRewardAmount.setName("_txtRewardAmount");
        this._nodeReward.addChild(this._txtRewardAmount);
        ...
        this._txtRewardAmount.setPosition(36, 0);
        this._txtRewardAmount.setTextColor(cc.color(239, 179, 63, 255));
        ...
        this._txtRewardAmount.setDefaultFontSize(42);
        ...
        this._txtRewardAmount.addChild(this._imgRewardIcon);
        this._imgRewardIcon.setCascadeOpacityEnabled(true);
        this._imgRewardIcon.setCascadeColorEnabled(true);
        this._imgRewardIcon.setAnchorPoint(cc.p(1, 0.5));
        ck.UIUtils.setPositionPercent(this._imgRewardIcon, 0, 0.5);
        ...
        _imgRewardIconLayoutComponent.setPositionPercentX(0);
        ...
        this._imgRewardIcon.setContentSize(cc.size(65, 65));
        ...
        ck.UIUtils.setPositionPercent(this._gridItems, 0.5, 0.5);
        ...
        _gridItemsLayoutComponent.setPositionPercentY(0.5);
        ...
        ///// # _layoutEvent
        this._layoutEvent = new ck.GridViewVertical();
        this._layoutEvent.setName("_layoutEvent");
        this._root.addChild(this._layoutEvent);
        this._layoutEvent.setCascadeOpacityEnabled(true);
        this._layoutEvent.setCascadeColorEnabled(true);
        this._layoutEvent.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._layoutEvent, 0.5, 0.1);
        let _layoutEventLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._layoutEvent);
        _layoutEventLayoutComponent.setPercentWidthEnabled(true);
        _layoutEventLayoutComponent.setPercentWidth(1);
        _layoutEventLayoutComponent.setPercentHeightEnabled(true);
        _layoutEventLayoutComponent.setPercentHeight(0.2);
        _layoutEventLayoutComponent.setVerticalEdge(ccui.LayoutComponent.verticalEdge.BOTTOM);
        _layoutEventLayoutComponent.setBottomMargin(0);
    ...
    resetCCSAnimHaveBonus: function () {
        this._nodeReward.stopAllActions();
        this._nodeReward.setPosition(170.88, 210);
    ...
    resetCCSAnimNoBonus: function () {
        this._nodeReward.stopAllActions();
        this._nodeReward.setPosition(170.88, 150);
...
/**
 * Create PaymentSuccessPopup
 * @returns {_ccs.PaymentSuccessPopup}
 */
_ccs.PaymentSuccessPopup.create = function () {
    return new _ccs.PaymentSuccessPopup();
};
