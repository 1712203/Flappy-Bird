 ...
 *
 */
_ccs.PaymentChannels = ccui.Widget.extend({
    ...
    /**
     * _ccs.PaymentChannels constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create PaymentChannels
 * @returns {_ccs.PaymentChannels}
 */
_ccs.PaymentChannels.create = function () {
    return new _ccs.PaymentChannels();
};
