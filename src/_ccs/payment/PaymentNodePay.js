 ...
 *
 */
_ccs.PaymentNodePay = ccui.Widget.extend({
    ...
    /**
     * _ccs.PaymentNodePay constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create PaymentNodePay
 * @returns {_ccs.PaymentNodePay}
 */
_ccs.PaymentNodePay.create = function () {
    return new _ccs.PaymentNodePay();
};
