 ...
 *
 */
_ccs.MailTabLayout = ccui.Widget.extend({
    ...
    /**
     * _ccs.MailTabLayout constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create MailTabLayout
 * @returns {_ccs.MailTabLayout}
 */
_ccs.MailTabLayout.create = function () {
    return new _ccs.MailTabLayout();
};
