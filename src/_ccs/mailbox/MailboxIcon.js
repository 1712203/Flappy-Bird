 ...
 *
 */
_ccs.MailboxIcon = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgIcon.setAnchorPoint(cc.p(0.5, 0.1309));
        ...
        this._imgIcon.loadTexture("icons/color/basic/Mailbox.png", 1);
        ...
        this._txtName.setString(gm.localize.getText("TXT_MAILBOX"));
        ...
        ck.UIUtils.setPositionPercent(this._imgRedDot, 0.7524, 0.62);
        ...
        _imgRedDotLayoutComponent.setPositionPercentX(0.7524);
        _imgRedDotLayoutComponent.setPositionPercentYEnabled(true);
        _imgRedDotLayoutComponent.setPositionPercentY(0.62);
...
/**
 * Create MailboxIcon
 * @returns {_ccs.MailboxIcon}
 */
_ccs.MailboxIcon.create = function () {
    return new _ccs.MailboxIcon();
};
