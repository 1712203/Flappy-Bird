...
_ccs.EmoHi = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this.Char_1.setPosition(1.2672, 0.3);
        let Char_1LayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this.Char_1);
        let sf = cc.spriteFrameCache.getSpriteFrame("emoticons/Emo_Girl_01.png"); if (sf) this.Char_1.setSpriteFrame(sf);
 ...
 * @returns {_ccs.EmoHi}
 */
_ccs.EmoHi.create = function () {
    return new _ccs.EmoHi();
};
