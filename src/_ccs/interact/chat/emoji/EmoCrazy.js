 ...
 *
 */
_ccs.EmoCrazy = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this.Char_1.setPosition(0.9414, 0.34);
        let Char_1LayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this.Char_1);
        let sf = cc.spriteFrameCache.getSpriteFrame("emoticons/Emo_Girl_04.png"); if (sf) this.Char_1.setSpriteFrame(sf);
...
/**
 * Create EmoCrazy
 * @returns {_ccs.EmoCrazy}
 */
_ccs.EmoCrazy.create = function () {
    return new _ccs.EmoCrazy();
};
