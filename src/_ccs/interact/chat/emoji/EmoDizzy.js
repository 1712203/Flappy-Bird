 ...
 *
 */
_ccs.EmoDizzy = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this.Char_1.setPosition(1.5152, 0.3);
        let Char_1LayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this.Char_1);
        let sf = cc.spriteFrameCache.getSpriteFrame("emoticons/Emo_Girl_06.png"); if (sf) this.Char_1.setSpriteFrame(sf);
...
/**
 * Create EmoDizzy
 * @returns {_ccs.EmoDizzy}
 */
_ccs.EmoDizzy.create = function () {
    return new _ccs.EmoDizzy();
};
