 ...
 *
 */
_ccs.EmoCry = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this.Char_1.setPosition(0.6858, 0.374);
        let Char_1LayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this.Char_1);
        let sf = cc.spriteFrameCache.getSpriteFrame("emoticons/Emo_Girl_03.png"); if (sf) this.Char_1.setSpriteFrame(sf);
 ...
 * @returns {_ccs.EmoCry}
 */
_ccs.EmoCry.create = function () {
    return new _ccs.EmoCry();
};
