 ...
 *
 */
_ccs.QuestRewardWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.QuestRewardWidget constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create QuestRewardWidget
 * @returns {_ccs.QuestRewardWidget}
 */
_ccs.QuestRewardWidget.create = function () {
    return new _ccs.QuestRewardWidget();
};
