 ...
 *
 */
_ccs.QuestIcon = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgIcon.setAnchorPoint(cc.p(0.5, 0.08));
        ...
        this._imgIcon.loadTexture("icons/color/basic/Quest.png", 1);
        ...
        this._txtName.setString(gm.localize.getText("TXT_QUEST"));
        ...
        ck.UIUtils.setPositionPercent(this._imgRedDot, 0.7471, 0.7165);
        ...
        _imgRedDotLayoutComponent.setPositionPercentX(0.7471);
        _imgRedDotLayoutComponent.setPositionPercentYEnabled(true);
        _imgRedDotLayoutComponent.setPositionPercentY(0.7165);
...
/**
 * Create QuestIcon
 * @returns {_ccs.QuestIcon}
 */
_ccs.QuestIcon.create = function () {
    return new _ccs.QuestIcon();
};
