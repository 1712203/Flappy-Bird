 ...
 *
 */
_ccs.PinballButtonWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.PinballButtonWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imageShadow.setColor(cc.color(184, 120, 73, 255));
        ...
        ck.UIUtils.setPositionPercent(this._layoutIcon, 0.5, 0.609);
        this._layoutIcon.setScale(1.2, 1.2);
        ...
        this._imgIcon.loadTexture("home/IconPinball.png", 1);
        this._imgIcon.setUnifySizeEnabled(false);
        this._imgIcon.ignoreContentAdaptWithSize(false);
        this._imgIcon.setContentSize(cc.size(120, 84));
        ...
        ck.UIUtils.setPositionPercent(this._imgBgrText, 0.5, -0.0002);
        this._imgBgrText.setVisible(false);
        ...
        _imgBgrTextLayoutComponent.setPositionPercentY(-0.0002);
        ...
        ck.UIUtils.setPositionPercent(this._imgText, 0.507, 0.1948);
        ...
        _imgTextLayoutComponent.setPositionPercentX(0.507);
        _imgTextLayoutComponent.setPositionPercentYEnabled(true);
        _imgTextLayoutComponent.setPositionPercentY(0.1948);
        this._imgText.loadTexture("texts/home/MiniGamePinball.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._txtText, 0.5, 0.2481);
        this._txtText.setTextColor(cc.color(255, 186, 153, 255));
    ...
    resetCCSAnimNoBackground: function () {
        ...
        this._layoutIcon.setPosition(75, 81);
    ...
    resetCCSAnimWithBackground: function () {
        ...
        this._layoutIcon.stopAllActions();
        this._layoutIcon.setPosition(75, 90);
...
/**
 * Create PinballButtonWidget
 * @returns {_ccs.PinballButtonWidget}
 */
_ccs.PinballButtonWidget.create = function () {
    return new _ccs.PinballButtonWidget();
};
