 ...
 *
 */
_ccs.BingoEffectWinWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.BingoEffectWinWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgGlow.loadTexture("bingo/ui/GlowWin.png", 1);
        this._imgGlow.setUnifySizeEnabled(false);
        this._imgGlow.ignoreContentAdaptWithSize(false);
        this._imgGlow.setContentSize(cc.size(640, 831));
        ...
        this._imgEmo.loadTexture("bingo/ui/EmojiWin.png", 1);
        this._imgEmo.setUnifySizeEnabled(false);
        this._imgEmo.ignoreContentAdaptWithSize(false);
        this._imgEmo.setContentSize(cc.size(178, 283));
        ...
        ck.UIUtils.setPositionPercent(this._imgRibbon, 0.5, 0.0353);
        ...
        this._imgRibbon.loadTexture("basics/popup/HeaderRed_02.png", 1);
        this._imgRibbon.setUnifySizeEnabled(false);
        this._imgRibbon.ignoreContentAdaptWithSize(false);
        this._imgRibbon.setContentSize(cc.size(504, 197));
        ...
        ck.UIUtils.setPositionPercent(this._imgText, 0.5, -0.0919);
        ...
        this._imgText.loadTexture("texts/minigames/YouWon.png", 1);
...
/**
 * Create BingoEffectWinWidget
 * @returns {_ccs.BingoEffectWinWidget}
 */
_ccs.BingoEffectWinWidget.create = function () {
    return new _ccs.BingoEffectWinWidget();
};
