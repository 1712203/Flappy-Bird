 ...
 *
 */
_ccs.FriendIcon = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgIcon.setAnchorPoint(cc.p(0.5, 0.07));
        ...
        this._imgIcon.loadTexture("icons/color/basic/Friend.png", 1);
        ...
        this._txtName.setString(gm.localize.getText("TXT_FRIEND"));
        ...
        ck.UIUtils.setPositionPercent(this._imgRedDot, 0.7356, 0.7089);
        ...
        _imgRedDotLayoutComponent.setPositionPercentX(0.7356);
        _imgRedDotLayoutComponent.setPositionPercentYEnabled(true);
        _imgRedDotLayoutComponent.setPositionPercentY(0.7089);
...
/**
 * Create FriendIcon
 * @returns {_ccs.FriendIcon}
 */
_ccs.FriendIcon.create = function () {
    return new _ccs.FriendIcon();
};
