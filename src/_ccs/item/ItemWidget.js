 ...
 *
 */
_ccs.ItemWidget = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._txtAmount.setDefaultFontSize(27);
...
/**
 * Create ItemWidget
 * @returns {_ccs.ItemWidget}
 */
_ccs.ItemWidget.create = function () {
    return new _ccs.ItemWidget();
};
