 ...
 *
 */
_ccs.ItemWidgetLarge = ccui.Widget.extend({
    ...
    /**
     * _ccs.ItemWidgetLarge constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.55);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.55);
        ...
        this._imgIcon.setContentSize(cc.size(85, 85));
        ...
        ck.UIUtils.setPositionPercent(this._txtAmount, 0.5, 0.22);
        ...
        _txtAmountLayoutComponent.setPositionPercentY(0.22);
        _txtAmountLayoutComponent.setPercentWidthEnabled(true);
        _txtAmountLayoutComponent.setPercentWidth(0.94);
        ...
        ck.UIUtils.setWidthPercent(this._txtAmount, 0.94);
        this._txtAmount.setContentSize(cc.size(this._txtAmount.width, 55));
...
/**
 * Create ItemWidgetLarge
 * @returns {_ccs.ItemWidgetLarge}
 */
_ccs.ItemWidgetLarge.create = function () {
    return new _ccs.ItemWidgetLarge();
};
