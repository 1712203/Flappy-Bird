 ...
 *
 */
_ccs.PistiSummaryItemWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.PistiSummaryItemWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._layoutRoot.setContentSize(cc.size(148, 120));
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.6);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.6);
        ...
        this._imgIcon.setContentSize(cc.size(72.7205, 72.7205));
        ...
        ck.UIUtils.setPositionPercent(this._txtAmount, 0.5, 0.19);
        ...
        _txtAmountLayoutComponent.setPositionPercentY(0.19);
        ...
        this._txtAmount.enableOutline(cc.color(0, 0, 0, 255), 2);
...
/**
 * Create PistiSummaryItemWidget
 * @returns {_ccs.PistiSummaryItemWidget}
 */
_ccs.PistiSummaryItemWidget.create = function () {
    return new _ccs.PistiSummaryItemWidget();
};
