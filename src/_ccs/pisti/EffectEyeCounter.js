 ...
 *
 */
_ccs.EffectEyeCounter = ccui.Widget.extend({
    ...
    /**
     * _ccs.EffectEyeCounter constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._icon.loadTexture("icons/color/items/EyeCounter.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._highlight, 0.5, 0.5);
        ...
        _highlightLayoutComponent.setPositionPercentX(0.5);
        _highlightLayoutComponent.setPositionPercentYEnabled(true);
        _highlightLayoutComponent.setPositionPercentY(0.5);
    ...
    playCCSAnimHide: function (delay = 0, callback = null, repeat = 1, speed = 1) {
        ...
        let _iconAction = cc.sequence(
            cc.spawn(
                cc.scaleTo(15 / (30 * speed), 2.5, 2.5),
    ...
    playCCSAnimIdle: function (delay = 0, callback = null, repeat = 1, speed = 1) {
        ...
        let _iconAction = cc.sequence(
            cc.spawn(
                cc.scaleTo(15 / (30 * speed), 1, 1).easing(cc.easeBackIn()),
                cc.fadeTo(15 / (30 * speed), 255)
            ),
            cc.callFunc(function () {
                if (repeat === 1) return;
...
/**
 * Create EffectEyeCounter
 * @returns {_ccs.EffectEyeCounter}
 */
_ccs.EffectEyeCounter.create = function () {
    return new _ccs.EffectEyeCounter();
};
