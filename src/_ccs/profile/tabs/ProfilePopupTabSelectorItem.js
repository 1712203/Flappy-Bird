...
/**
 * _ccs.ProfilePopupTabSelectorItem
 *
 ...
 *
 */
_ccs.ProfilePopupTabSelectorItem = ccui.Widget.extend({
    ...
    /**
     * _ccs.ProfilePopupTabSelectorItem constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._layoutRoot.setContentSize(cc.size(130, 70));
        ...
        _imgHighlightLayoutComponent.setPercentWidth(0.96);
        ...
        ck.UIUtils.setSizePercent(this._imgHighlight, 0.96, 0.8648);
        ...
        this._txtName.setContentSize(cc.size(84, 58));
        ...
        ck.UIUtils.setPositionPercent(this._imgRedDot, 0.9173, 0.8548);
        ...
        _imgRedDotLayoutComponent.setPositionPercentX(0.9173);
        _imgRedDotLayoutComponent.setPositionPercentYEnabled(true);
        _imgRedDotLayoutComponent.setPositionPercentY(0.8548);
...
/**
 * Create ProfilePopupTabSelectorItem
 * @returns {_ccs.ProfilePopupTabSelectorItem}
 */
_ccs.ProfilePopupTabSelectorItem.create = function () {
    return new _ccs.ProfilePopupTabSelectorItem();
};
