 ...
 *
 */
_ccs.TableSkinWidgetBig = ccui.Widget.extend({
    ...
    /**
     * _ccs.TableSkinWidgetBig constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgItem, 0.55, 0.5);
        this._imgItem.setFlippedX(true);
...
/**
 * Create TableSkinWidgetBig
 * @returns {_ccs.TableSkinWidgetBig}
 */
_ccs.TableSkinWidgetBig.create = function () {
    return new _ccs.TableSkinWidgetBig();
};
