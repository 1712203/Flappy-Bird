 ...
 *
 */
_ccs.CardSkinWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.CardSkinWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgItem.setContentSize(cc.size(120.9, 166.4));
...
/**
 * Create CardSkinWidget
 * @returns {_ccs.CardSkinWidget}
 */
_ccs.CardSkinWidget.create = function () {
    return new _ccs.CardSkinWidget();
};
