...
/**
 * _ccs.SkinTabLayoutTabSelectorItem
 *
 ...
 *
 */
_ccs.SkinTabLayoutTabSelectorItem = ccui.Widget.extend({
    ...
    /**
     * _ccs.SkinTabLayoutTabSelectorItem constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._layoutRoot.setContentSize(cc.size(204, 67));
        ...
        this._imgBgrNormal.loadTexture("basics/tabs/Tab04.png", 1);
        ...
        this._imgBgrNormal.setCapInsets(cc.rect(15, 11, 170, 35));
        this._imgBgrNormal.setContentSize(cc.size(200, 57));
        ...
        this._imgBgrSelected.loadTexture("basics/tabs/Tab03.png", 1);
        ...
        this._imgBgrSelected.setCapInsets(cc.rect(15, 11, 174, 45));
        this._imgBgrSelected.setContentSize(cc.size(204, 67));
        ...
        ck.UIUtils.setPositionPercent(this._txtName, 0.5, 0.425);
        ...
        _txtNameLayoutComponent.setPositionPercentY(0.425);
        ...
        ck.UIUtils.setPositionPercent(this._imgRedDot, 0.9553, 0.85);
        this._imgRedDot.setScale(0.65, 0.65);
        ...
        _imgRedDotLayoutComponent.setPositionPercentX(0.9553);
        _imgRedDotLayoutComponent.setPositionPercentYEnabled(true);
        _imgRedDotLayoutComponent.setPositionPercentY(0.85);
...
/**
 * Create SkinTabLayoutTabSelectorItem
 * @returns {_ccs.SkinTabLayoutTabSelectorItem}
 */
_ccs.SkinTabLayoutTabSelectorItem.create = function () {
    return new _ccs.SkinTabLayoutTabSelectorItem();
};
