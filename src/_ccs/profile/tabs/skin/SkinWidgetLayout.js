 ...
 *
 */
_ccs.SkinWidgetLayout = ccui.Widget.extend({
    ...
    /**
     * _ccs.SkinWidgetLayout constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._layoutRoot.setContentSize(cc.size(640, 580.46));
...
/**
 * Create SkinWidgetLayout
 * @returns {_ccs.SkinWidgetLayout}
 */
_ccs.SkinWidgetLayout.create = function () {
    return new _ccs.SkinWidgetLayout();
};
