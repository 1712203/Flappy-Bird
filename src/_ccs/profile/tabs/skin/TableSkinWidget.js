 ...
 *
 */
_ccs.TableSkinWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.TableSkinWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgItem.loadTexture("tables/TableSkin00.png", 1);
        this._imgItem.setUnifySizeEnabled(false);
        this._imgItem.ignoreContentAdaptWithSize(false);
        this._imgItem.setContentSize(cc.size(135, 135));
        ...
        this._layoutDisable.setBackGroundColorOpacity(179);
...
/**
 * Create TableSkinWidget
 * @returns {_ccs.TableSkinWidget}
 */
_ccs.TableSkinWidget.create = function () {
    return new _ccs.TableSkinWidget();
};
