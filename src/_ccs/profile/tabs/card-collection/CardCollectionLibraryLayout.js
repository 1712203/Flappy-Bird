...
/**
 * _ccs.CardCollectionLibraryLayout
 *
 ...
 *
 */
_ccs.CardCollectionLibraryLayout = ccui.Widget.extend({

    /** @type {ccui.Layout} */
    _layoutRoot: null,
    /** @type {ck.CardCollectionLibraryTableView} */
    _tableViewWidgets: null,


    /**
     * _ccs.CardCollectionLibraryLayout constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ///// # _tableViewWidgets
        this._tableViewWidgets = new ck.CardCollectionLibraryTableView();
...
/**
 * Create CardCollectionLibraryLayout
 * @returns {_ccs.CardCollectionLibraryLayout}
 */
_ccs.CardCollectionLibraryLayout.create = function () {
    return new _ccs.CardCollectionLibraryLayout();
};
