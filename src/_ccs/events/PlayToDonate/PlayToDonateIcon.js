 ...
 *
 */
_ccs.PlayToDonateIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.PlayToDonateIcon constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create PlayToDonateIcon
 * @returns {_ccs.PlayToDonateIcon}
 */
_ccs.PlayToDonateIcon.create = function () {
    return new _ccs.PlayToDonateIcon();
};
