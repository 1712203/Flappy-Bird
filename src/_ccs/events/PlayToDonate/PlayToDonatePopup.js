 ...
 *
 */
_ccs.PlayToDonatePopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.PlayToDonatePopup constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create PlayToDonatePopup
 * @returns {_ccs.PlayToDonatePopup}
 */
_ccs.PlayToDonatePopup.create = function () {
    return new _ccs.PlayToDonatePopup();
};
