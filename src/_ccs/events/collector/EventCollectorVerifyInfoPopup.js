...
/**
 * _ccs.EventCollectorVerifyInfoPopup
 *
 ...
 *
 */
_ccs.EventCollectorVerifyInfoPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.EventCollectorVerifyInfoPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._txtInfoHint01, 0.5, 0.7248);
        ...
        _txtInfoHint01LayoutComponent.setPositionPercentY(0.7248);
        this._txtInfoHint01.setTouchEnabled(false);
        this._txtInfoHint01.setUnifySizeEnabled(false);
        this._txtInfoHint01.ignoreContentAdaptWithSize(false);
        this._txtInfoHint01.setContentSize(cc.size(502.4886, 95.7778));
        this._txtInfoHint01.setFontName("fonts/BebasNeueProBold.ttf");
        this._txtInfoHint01.setDefaultFontSize(25);
        this._txtInfoHint01.setString(gm.localize.getText("TXT_EVENT_COLLECTOR_VERIFY_INFO_MESSAGE"));
        ...
        ck.UIUtils.setPositionPercent(this._txtNameTitle, 0.076, 0.6141);
        ...
        _txtNameTitleLayoutComponent.setPositionPercentY(0.6141);
        ...
        ck.UIUtils.setPositionPercent(this._editBoxName, 0.6338, 0.606);
        ...
        _editBoxNameLayoutComponent.setPositionPercentY(0.606);
        ...
        ck.UIUtils.setPositionPercent(this._txtPhoneNumber, 0.076, 0.4981);
        ...
        _txtPhoneNumberLayoutComponent.setPositionPercentY(0.4981);
        ...
        ck.UIUtils.setPositionPercent(this._editBoxPhoneNumber, 0.6338, 0.4925);
        ...
        _editBoxPhoneNumberLayoutComponent.setPositionPercentY(0.4925);
        ...
        ck.UIUtils.setPositionPercent(this._txtAddress, 0.0778, 0.3816);
        ...
        _txtAddressLayoutComponent.setPositionPercentY(0.3816);
        ...
        ck.UIUtils.setPositionPercent(this._editBoxAddress, 0.6338, 0.3786);
        ...
        _editBoxAddressLayoutComponent.setPositionPercentY(0.3786);
        ...
        ck.UIUtils.setPositionPercent(this._txtEmail, 0.0778, 0.258);
        ...
        _txtEmailLayoutComponent.setPositionPercentY(0.258);
        ...
        ck.UIUtils.setPositionPercent(this._editBoxEmail, 0.6338, 0.263);
        ...
        _editBoxEmailLayoutComponent.setPositionPercentY(0.263);
        ...
        ck.UIUtils.setPositionPercent(this._imgFinish, 0.5, 0.1136);
        ...
        _imgFinishLayoutComponent.setPositionPercentY(0.1136);
...
/**
 * Create EventCollectorVerifyInfoPopup
 * @returns {_ccs.EventCollectorVerifyInfoPopup}
 */
_ccs.EventCollectorVerifyInfoPopup.create = function () {
    return new _ccs.EventCollectorVerifyInfoPopup();
};
