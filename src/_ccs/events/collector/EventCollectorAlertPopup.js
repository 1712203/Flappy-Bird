 ...
 *
 */
_ccs.EventCollectorAlertPopup = ccui.Widget.extend({
    ...
    /**
     * _ccs.EventCollectorAlertPopup constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._txtMessage.setString(gm.localize.getText("TXT_EVENT_COLLECTOR_NOT_ENOUGH_TOKEN_MESSAGE"));
...
/**
 * Create EventCollectorAlertPopup
 * @returns {_ccs.EventCollectorAlertPopup}
 */
_ccs.EventCollectorAlertPopup.create = function () {
    return new _ccs.EventCollectorAlertPopup();
};
