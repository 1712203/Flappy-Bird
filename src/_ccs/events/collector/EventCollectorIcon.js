 ...
 *
 */
_ccs.EventCollectorIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.EventCollectorIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgIcon.loadTexture("event-collector/IconEvent.png", 1);
        this._imgIcon.setUnifySizeEnabled(false);
        this._imgIcon.ignoreContentAdaptWithSize(false);
        this._imgIcon.setContentSize(cc.size(86.0289, 86.0289));
...
/**
 * Create EventCollectorIcon
 * @returns {_ccs.EventCollectorIcon}
 */
_ccs.EventCollectorIcon.create = function () {
    return new _ccs.EventCollectorIcon();
};
