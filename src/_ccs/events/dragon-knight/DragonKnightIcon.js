 ...
 *
 */
_ccs.DragonKnightIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.DragonKnightIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgIcon.loadTexture("icons/color/tokens/DragonEgg.png", 1);
...
/**
 * Create DragonKnightIcon
 * @returns {_ccs.DragonKnightIcon}
 */
_ccs.DragonKnightIcon.create = function () {
    return new _ccs.DragonKnightIcon();
};
