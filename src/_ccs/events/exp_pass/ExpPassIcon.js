 ...
 *
 */
_ccs.ExpPassIcon = ccui.Widget.extend({
...
/**
 * Create ExpPassIcon
 * @returns {_ccs.ExpPassIcon}
 */
_ccs.ExpPassIcon.create = function () {
    return new _ccs.ExpPassIcon();
};
