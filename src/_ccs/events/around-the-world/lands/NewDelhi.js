 ...
 *
 */
_ccs.NewDelhi = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(0.0001, 42.9989);
...
/**
 * Create NewDelhi
 * @returns {_ccs.NewDelhi}
 */
_ccs.NewDelhi.create = function () {
    return new _ccs.NewDelhi();
};
