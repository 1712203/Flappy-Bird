 ...
 *
 */
_ccs.Amsterdam = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(0, 32.9993);
...
/**
 * Create Amsterdam
 * @returns {_ccs.Amsterdam}
 */
_ccs.Amsterdam.create = function () {
    return new _ccs.Amsterdam();
};
