 ...
 *
 */
_ccs.London = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(-0.0001, 18.9989);
 ...
 * @returns {_ccs.London}
 */
_ccs.London.create = function () {
    return new _ccs.London();
};
