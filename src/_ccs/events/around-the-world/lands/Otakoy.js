 ...
 *
 */
_ccs.Otakoy = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgBuildingName.setPosition(34.0551, -15.6525);
        this._imgBuildingName.setRotationX(2);
        this._imgBuildingName.setRotationY(2.0002);
        let _imgBuildingNameLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgBuildingName);
        this._imgBuildingName.loadTexture("around-the-world/Text_Istanbul.png", 1);
        this._imgBuildingName.setUnifySizeEnabled(false);
        this._imgBuildingName.ignoreContentAdaptWithSize(false);
        this._imgBuildingName.setContentSize(cc.size(81, 60));
        ...
        this._imgCheck.setPosition(-0.0001, 33.9991);
 ...
 * @returns {_ccs.Otakoy}
 */
_ccs.Otakoy.create = function () {
    return new _ccs.Otakoy();
};
