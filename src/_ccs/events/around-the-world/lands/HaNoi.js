...
_ccs.HaNoi = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgBuilding.loadTexture("around-the-world/BuildingHaNoi.png", 1);
        this._imgBuilding.setUnifySizeEnabled(false);
        this._imgBuilding.ignoreContentAdaptWithSize(false);
        this._imgBuilding.setContentSize(cc.size(75, 94));
 ...
 * @returns {_ccs.HaNoi}
 */
_ccs.HaNoi.create = function () {
    return new _ccs.HaNoi();
};
