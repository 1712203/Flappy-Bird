...
_ccs.Tokyo = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(-0.0001, 32.9991);
 ...
 * @returns {_ccs.Tokyo}
 */
_ccs.Tokyo.create = function () {
    return new _ccs.Tokyo();
};
