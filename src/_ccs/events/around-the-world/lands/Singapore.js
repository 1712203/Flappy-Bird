 ...
 *
 */
_ccs.Singapore = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(-0.0003, 32.9991);
...
/**
 * Create Singapore
 * @returns {_ccs.Singapore}
 */
_ccs.Singapore.create = function () {
    return new _ccs.Singapore();
};
