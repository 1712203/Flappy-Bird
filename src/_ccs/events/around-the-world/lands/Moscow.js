 ...
 *
 */
_ccs.Moscow = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(-0.0001, 24.9996);
 ...
 * @returns {_ccs.Moscow}
 */
_ccs.Moscow.create = function () {
    return new _ccs.Moscow();
};
