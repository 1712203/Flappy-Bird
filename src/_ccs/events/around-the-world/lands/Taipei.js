 ...
 *
 */
_ccs.Taipei = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(-0.0001, 39.9993);
 ...
 * @returns {_ccs.Taipei}
 */
_ccs.Taipei.create = function () {
    return new _ccs.Taipei();
};
