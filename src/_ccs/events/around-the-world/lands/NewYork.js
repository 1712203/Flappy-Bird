 ...
 *
 */
_ccs.NewYork = ccui.Widget.extend({
    ...
    _initCCSChildren: function () {
        ...
        this._imgCheck.setPosition(-0.0034, 31.999);
...
/**
 * Create NewYork
 * @returns {_ccs.NewYork}
 */
_ccs.NewYork.create = function () {
    return new _ccs.NewYork();
};
