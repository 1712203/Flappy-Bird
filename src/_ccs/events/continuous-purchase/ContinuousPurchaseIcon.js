 ...
 *
 */
_ccs.ContinuousPurchaseIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.ContinuousPurchaseIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgIcon.loadTexture("icons/color/events/ContinuousPurchase.png", 1);
...
/**
 * Create ContinuousPurchaseIcon
 * @returns {_ccs.ContinuousPurchaseIcon}
 */
_ccs.ContinuousPurchaseIcon.create = function () {
    return new _ccs.ContinuousPurchaseIcon();
};
