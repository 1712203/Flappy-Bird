...
/**
 * _ccs.ContinuousPurchaseItemWidget
 *
 ...
 *
 */
_ccs.ContinuousPurchaseItemWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.ContinuousPurchaseItemWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._layoutRoot.setContentSize(cc.size(85, 85));
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.6733);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.6733);
        ...
        ck.UIUtils.setPositionPercent(this._txtAmount, 0.5, 0.1333);
        ...
        _txtAmountLayoutComponent.setPositionPercentY(0.1333);
...
/**
 * Create ContinuousPurchaseItemWidget
 * @returns {_ccs.ContinuousPurchaseItemWidget}
 */
_ccs.ContinuousPurchaseItemWidget.create = function () {
    return new _ccs.ContinuousPurchaseItemWidget();
};
