 ...
 *
 */
_ccs.HappySharkEventIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.HappySharkEventIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.52);
        ...
        _imgIconLayoutComponent.setPositionPercentY(0.52);
        this._imgIcon.loadTexture("icons/color/events/HappyShark.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._txtNumRedDot, 0.5123, 0.5217);
        ...
        _txtNumRedDotLayoutComponent.setPositionPercentY(0.5217);
...
/**
 * Create HappySharkEventIcon
 * @returns {_ccs.HappySharkEventIcon}
 */
_ccs.HappySharkEventIcon.create = function () {
    return new _ccs.HappySharkEventIcon();
};
