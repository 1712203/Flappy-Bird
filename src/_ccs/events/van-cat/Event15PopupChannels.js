 ...
 *
 */
_ccs.Event15PopupChannels = cc.Layer.extend({
    ...
    /**
     * _ccs.Event15PopupChannels constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create Event15PopupChannels
 * @returns {_ccs.Event15PopupChannels}
 */
_ccs.Event15PopupChannels.create = function () {
    return new _ccs.Event15PopupChannels();
};
