 ...
 *
 */
_ccs.DualWheelEventIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.DualWheelEventIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.5, 0.54);
        this._imgIcon.setScale(1.17, 1.17);
        ...
        this._imgIcon.loadTexture("icons/color/events/DualWheel.png", 1);
...
/**
 * Create DualWheelEventIcon
 * @returns {_ccs.DualWheelEventIcon}
 */
_ccs.DualWheelEventIcon.create = function () {
    return new _ccs.DualWheelEventIcon();
};
