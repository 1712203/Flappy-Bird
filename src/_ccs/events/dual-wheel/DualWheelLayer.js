 ...
 *
 */
_ccs.DualWheelLayer = cc.Layer.extend({
    ...
    _dualWheel: null,
    /** @type {ccui.ImageView} */
    _imgBackgroundDualWheel: null,
    /** @type {ck.Slot} */
    _wheelLeft: null,
    /** @type {ccui.ImageView} */
    _imgBackgroundWheelLeft: null,
    /** @type {cc.Node} */
    _layoutNeedle: null,
    /** @type {ccui.Layout} */
    ...
    /**
     * _ccs.DualWheelLayer constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        ck.UIUtils.setPositionPercent(this._layoutMain, 0.5, 0.565);
        ...
        this._layoutMain.setContentSize(cc.size(this._layoutMain.width, 608));

        ///// # _dualWheel
        this._dualWheel = new ck.SlotMachine();
        this._dualWheel.setName("_dualWheel");
        this._layoutMain.addChild(this._dualWheel);
        this._dualWheel.setCascadeOpacityEnabled(true);
        this._dualWheel.setCascadeColorEnabled(true);
        this._dualWheel.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._dualWheel, 0.5, 0.5);
        let _dualWheelLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._dualWheel);
        _dualWheelLayoutComponent.setPositionPercentXEnabled(true);
        _dualWheelLayoutComponent.setPositionPercentX(0.5);
        _dualWheelLayoutComponent.setPositionPercentYEnabled(true);
        _dualWheelLayoutComponent.setPositionPercentY(0.5);
        this._dualWheel.setUnifySizeEnabled(false);
        this._dualWheel.ignoreContentAdaptWithSize(false);
        this._dualWheel.setContentSize(cc.size(640, 608));
        this._dualWheel.setTouchEnabled(false);

        ///// # _imgBackgroundDualWheel
        this._imgBackgroundDualWheel = new ccui.ImageView();
        this._imgBackgroundDualWheel.setName("_imgBackgroundDualWheel");
        this._dualWheel.addChild(this._imgBackgroundDualWheel);
        this._imgBackgroundDualWheel.setCascadeOpacityEnabled(true);
        this._imgBackgroundDualWheel.setCascadeColorEnabled(true);
        this._imgBackgroundDualWheel.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._imgBackgroundDualWheel, 0.5, 0.5);
        let _imgBackgroundDualWheelLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgBackgroundDualWheel);
        _imgBackgroundDualWheelLayoutComponent.setPositionPercentXEnabled(true);
        _imgBackgroundDualWheelLayoutComponent.setPositionPercentX(0.5);
        _imgBackgroundDualWheelLayoutComponent.setPositionPercentYEnabled(true);
        _imgBackgroundDualWheelLayoutComponent.setPositionPercentY(0.5);
        this._imgBackgroundDualWheel.loadTexture("dual-wheel/Board.png", 1);
        this._imgBackgroundDualWheel.setUnifySizeEnabled(false);
        this._imgBackgroundDualWheel.ignoreContentAdaptWithSize(false);
        this._imgBackgroundDualWheel.setContentSize(cc.size(640, 608));
        this._imgBackgroundDualWheel.setTouchEnabled(false);

        ///// # _wheelLeft
        this._wheelLeft = new ck.Slot();
        this._wheelLeft.setName("_wheelLeft");
        this._dualWheel.addChild(this._wheelLeft);
        this._wheelLeft.setCascadeOpacityEnabled(true);
        this._wheelLeft.setCascadeColorEnabled(true);
        this._wheelLeft.setAnchorPoint(cc.p(1, 0.5));
        ck.UIUtils.setPositionPercent(this._wheelLeft, 0.5, 0.51);
        let _wheelLeftLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._wheelLeft);
        _wheelLeftLayoutComponent.setPositionPercentXEnabled(true);
        _wheelLeftLayoutComponent.setPositionPercentX(0.5);
        _wheelLeftLayoutComponent.setPositionPercentYEnabled(true);
        _wheelLeftLayoutComponent.setPositionPercentY(0.51);
        this._wheelLeft.setUnifySizeEnabled(false);
        this._wheelLeft.ignoreContentAdaptWithSize(false);
        this._wheelLeft.setContentSize(cc.size(247, 298));
        this._wheelLeft.setTouchEnabled(false);

        ///// # _imgBackgroundWheelLeft
        this._imgBackgroundWheelLeft = new ccui.ImageView();
        this._imgBackgroundWheelLeft.setName("_imgBackgroundWheelLeft");
        this._wheelLeft.addChild(this._imgBackgroundWheelLeft);
        this._imgBackgroundWheelLeft.setCascadeOpacityEnabled(true);
        this._imgBackgroundWheelLeft.setCascadeColorEnabled(true);
        this._imgBackgroundWheelLeft.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._imgBackgroundWheelLeft, 0.495, 0.5);
        let _imgBackgroundWheelLeftLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgBackgroundWheelLeft);
        _imgBackgroundWheelLeftLayoutComponent.setPositionPercentXEnabled(true);
        _imgBackgroundWheelLeftLayoutComponent.setPositionPercentX(0.495);
        _imgBackgroundWheelLeftLayoutComponent.setPositionPercentYEnabled(true);
        _imgBackgroundWheelLeftLayoutComponent.setPositionPercentY(0.5);
        this._imgBackgroundWheelLeft.loadTexture("dual-wheel/WheelContainerLeft.png", 1);
        this._imgBackgroundWheelLeft.setUnifySizeEnabled(false);
        this._imgBackgroundWheelLeft.ignoreContentAdaptWithSize(false);
        this._imgBackgroundWheelLeft.setContentSize(cc.size(247, 298));
        this._imgBackgroundWheelLeft.setTouchEnabled(false);

        ///// # _layoutNeedle
        this._layoutNeedle = new cc.Node();
        this._layoutNeedle.setName("_layoutNeedle");
        this._wheelLeft.addChild(this._layoutNeedle);
        ...
        this._wheelLeft.addChild(this._layoutContainer);
        ...
        ///// # initChildren for this._wheelLeft;
        this._wheelLeft.initChildren();

        ///// # _wheelRight
        this._wheelRight = new ck.Slot();
        this._wheelRight.setName("_wheelRight");
        this._dualWheel.addChild(this._wheelRight);
        this._wheelRight.setCascadeOpacityEnabled(true);
        this._wheelRight.setCascadeColorEnabled(true);
        this._wheelRight.setAnchorPoint(cc.p(0, 0.5));
        ck.UIUtils.setPositionPercent(this._wheelRight, 0.5, 0.51);
        let _wheelRightLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._wheelRight);
        _wheelRightLayoutComponent.setPositionPercentXEnabled(true);
        _wheelRightLayoutComponent.setPositionPercentX(0.5);
        _wheelRightLayoutComponent.setPositionPercentYEnabled(true);
        _wheelRightLayoutComponent.setPositionPercentY(0.51);
        this._wheelRight.setUnifySizeEnabled(false);
        this._wheelRight.ignoreContentAdaptWithSize(false);
        this._wheelRight.setContentSize(cc.size(247, 298));
        this._wheelRight.setTouchEnabled(false);

        ///// # _imgBackgroundWheelRight
        this._imgBackgroundWheelRight = new ccui.ImageView();
        this._imgBackgroundWheelRight.setName("_imgBackgroundWheelRight");
        this._wheelRight.addChild(this._imgBackgroundWheelRight);
        this._imgBackgroundWheelRight.setCascadeOpacityEnabled(true);
        this._imgBackgroundWheelRight.setCascadeColorEnabled(true);
        this._imgBackgroundWheelRight.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._imgBackgroundWheelRight, 0.495, 0.5);
        let _imgBackgroundWheelRightLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgBackgroundWheelRight);
        _imgBackgroundWheelRightLayoutComponent.setPositionPercentXEnabled(true);
        _imgBackgroundWheelRightLayoutComponent.setPositionPercentX(0.495);
        _imgBackgroundWheelRightLayoutComponent.setPositionPercentYEnabled(true);
        _imgBackgroundWheelRightLayoutComponent.setPositionPercentY(0.5);
        this._imgBackgroundWheelRight.loadTexture("dual-wheel/WheelContainerRight.png", 1);
        this._imgBackgroundWheelRight.setUnifySizeEnabled(false);
        this._imgBackgroundWheelRight.ignoreContentAdaptWithSize(false);
        this._imgBackgroundWheelRight.setContentSize(cc.size(246, 298));
        this._imgBackgroundWheelRight.setTouchEnabled(false);

        ///// # _layoutNeedle
        this._layoutNeedle = new cc.Node();
        this._layoutNeedle.setName("_layoutNeedle");
        this._wheelRight.addChild(this._layoutNeedle);
        this._layoutNeedle.setCascadeOpacityEnabled(true);
        this._layoutNeedle.setCascadeColorEnabled(true);
        ck.UIUtils.setPositionPercent(this._layoutNeedle, 0.5, 0.5);
        let _layoutNeedleLayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._layoutNeedle);
        ...
        this._layoutContainer = new ccui.Layout();
        this._layoutContainer.setName("_layoutContainer");
        this._wheelRight.addChild(this._layoutContainer);
        this._layoutContainer.setCascadeOpacityEnabled(true);
        this._layoutContainer.setCascadeColorEnabled(true);
        this._layoutContainer.setAnchorPoint(cc.p(0.5, 0.5));
        ck.UIUtils.setPositionPercent(this._layoutContainer, 0.5, 0.5);
        ...
        ///// # initChildren for this._wheelRight;
        this._wheelRight.initChildren();

        ///// # _layoutReward
        this._layoutReward = new ccui.Layout();
        this._layoutReward.setName("_layoutReward");
        this._dualWheel.addChild(this._layoutReward);
        ...
        ck.UIUtils.setPositionPercent(this._layoutReward, 0.5, 0.8505);
        ...
        _layoutRewardLayoutComponent.setPositionPercentY(0.8505);
        ...
        this._layoutReward.setContentSize(cc.size(430.6357, 100));
        ...
        ck.UIUtils.setPositionPercent(this._imgBackgroundReward, 0.5, 0.34);
        ...
        _imgBackgroundRewardLayoutComponent.setPositionPercentY(0.34);
        this._imgBackgroundReward.loadTexture("dual-wheel/RewardBoard.png", 1);
        this._imgBackgroundReward.setUnifySizeEnabled(false);
        this._imgBackgroundReward.ignoreContentAdaptWithSize(false);
        this._imgBackgroundReward.setContentSize(cc.size(446, 129));
        ...
        ck.UIUtils.setPositionPercent(this._txtAmountReward, 0.57, 0.5);
        this._txtAmountReward.setTextColor(cc.color(255, 249, 210, 255));
        ...
        _txtAmountRewardLayoutComponent.setPositionPercentY(0.5);
        this._txtAmountReward.setTouchEnabled(false);
        this._txtAmountReward.ignoreContentAdaptWithSize(true);
        this._txtAmountReward.setFontName("fonts/GroBold.ttf");
        ...
        this._txtAmountReward.enableOutline(cc.color(129, 48, 19, 255), 4);
        this._txtAmountReward.enableShadow(cc.color(92, 88, 88, 255), cc.size(0, -3), 0);
        ...
        ck.UIUtils.setPositionPercent(this._imgIconReward, -0.037, 0.5);
        ...
        _imgIconRewardLayoutComponent.setPositionPercentY(0.5);
        ...
        this._dualWheel.addChild(this._imgNeedle);
        this._imgNeedle.setCascadeOpacityEnabled(true);
        this._imgNeedle.setCascadeColorEnabled(true);
        this._imgNeedle.setAnchorPoint(cc.p(0.46, 0.73));
        ck.UIUtils.setPositionPercent(this._imgNeedle, 0.0531, 0.5085);
        this._imgNeedle.setRotation(-90);
        ...
        _imgNeedleLayoutComponent.setPositionPercentY(0.5085);
        this._imgNeedle.loadTexture("dual-wheel/Needle.png", 1);
        this._imgNeedle.setUnifySizeEnabled(false);
        this._imgNeedle.ignoreContentAdaptWithSize(false);
        this._imgNeedle.setContentSize(cc.size(53, 89));
        ...
        this._dualWheel.addChild(this._gridviewButtonTickets);
        ...
        ck.UIUtils.setPositionPercent(this._gridviewButtonTickets, 0.5, 0.0725);
        ...
        _gridviewButtonTicketsLayoutComponent.setPositionPercentY(0.0725);
        ...
        this._layoutMain.addChild(this._imgDecor00);
        this._imgDecor00.setCascadeOpacityEnabled(true);
        this._imgDecor00.setCascadeColorEnabled(true);
        this._imgDecor00.setAnchorPoint(cc.p(0, 0.5));
        ck.UIUtils.setPositionPercent(this._imgDecor00, 0, 0.1);
        let _imgDecor00LayoutComponent = ccui.LayoutComponent.bindLayoutComponent(this._imgDecor00);
        _imgDecor00LayoutComponent.setPositionPercentXEnabled(true);
        _imgDecor00LayoutComponent.setPositionPercentX(0);
        _imgDecor00LayoutComponent.setPositionPercentYEnabled(true);
        _imgDecor00LayoutComponent.setPositionPercentY(0.1);
        this._imgDecor00.loadTexture("dual-wheel/Decor01.png", 1);
        this._imgDecor00.setUnifySizeEnabled(false);
        this._imgDecor00.ignoreContentAdaptWithSize(false);
        this._imgDecor00.setContentSize(cc.size(111, 424));
        this._imgDecor00.setTouchEnabled(false);

        ///// # _imgDecor01
        this._imgDecor01 = new ccui.ImageView();
        this._imgDecor01.setName("_imgDecor01");
        this._layoutMain.addChild(this._imgDecor01);
        this._imgDecor01.setCascadeOpacityEnabled(true);
        this._imgDecor01.setCascadeColorEnabled(true);
        this._imgDecor01.setAnchorPoint(cc.p(1, 0.5));
        ck.UIUtils.setPositionPercent(this._imgDecor01, 1.08, -0.11);
        ...
        _shopEventLayoutComponent.setPositionPercentX(0.9272);
        _shopEventLayoutComponent.setPositionPercentYEnabled(true);
        _shopEventLayoutComponent.setPositionPercentY(0.0785);
        ...
        ck.UIUtils.setPositionPercent(this._btnSpin, 0.5, 0.21);
        ...
        _btnSpinLayoutComponent.setPositionPercentY(0.21);
        ...
        ck.UIUtils.setPositionPercent(this._nodeEffectSpin, 0.5, 0.4684);
...
/**
 * Create DualWheelLayer
 * @returns {_ccs.DualWheelLayer}
 */
_ccs.DualWheelLayer.create = function () {
    return new _ccs.DualWheelLayer();
};
