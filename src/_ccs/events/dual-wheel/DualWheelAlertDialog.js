 ...
 *
 */
_ccs.DualWheelAlertDialog = ccui.Widget.extend({
    ...
    /**
     * _ccs.DualWheelAlertDialog constructor
     * @constructor
     */
    ctor: function () {
...
/**
 * Create DualWheelAlertDialog
 * @returns {_ccs.DualWheelAlertDialog}
 */
_ccs.DualWheelAlertDialog.create = function () {
    return new _ccs.DualWheelAlertDialog();
};
