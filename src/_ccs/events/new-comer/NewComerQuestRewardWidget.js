...
/**
 * _ccs.NewComerQuestRewardWidget
 *
 ...
 *
 */
_ccs.NewComerQuestRewardWidget = ccui.Widget.extend({
    ...
    /**
     * _ccs.NewComerQuestRewardWidget constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._layoutRoot.setContentSize(cc.size(106.4362, 32.9109));
        ...
        ck.UIUtils.setPositionPercent(this._imgIcon, 0.1705, 0.5);
        ...
        _imgIconLayoutComponent.setPositionPercentX(0.1705);
        ...
        ck.UIUtils.setPositionPercent(this._txtAmount, 0.7438, 0.4648);
        ...
        _txtAmountLayoutComponent.setPositionPercentX(0.7438);
        _txtAmountLayoutComponent.setPositionPercentYEnabled(true);
        _txtAmountLayoutComponent.setPositionPercentY(0.4648);
        ...
        this._txtAmount.setDefaultFontSize(25);
...
/**
 * Create NewComerQuestRewardWidget
 * @returns {_ccs.NewComerQuestRewardWidget}
 */
_ccs.NewComerQuestRewardWidget.create = function () {
    return new _ccs.NewComerQuestRewardWidget();
};
