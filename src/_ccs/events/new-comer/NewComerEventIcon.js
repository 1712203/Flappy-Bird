 ...
 *
 */
_ccs.NewComerEventIcon = ccui.Widget.extend({
    ...
    /**
     * _ccs.NewComerEventIcon constructor
     * @constructor
     */
    ctor: function () {
    ...
    _initCCSChildren: function () {
        ...
        this._imgIcon.loadTexture("texts/new-comer/PistiMasterIcon.png", 1);
        ...
        ck.UIUtils.setPositionPercent(this._txtNumRedDot, 0.4958, 0.5384);
        ...
        _txtNumRedDotLayoutComponent.setPositionPercentX(0.4958);
        _txtNumRedDotLayoutComponent.setPositionPercentYEnabled(true);
        _txtNumRedDotLayoutComponent.setPositionPercentY(0.5384);
        ...
        this._imgTimeLeft.setContentSize(cc.size(100, 100));
...
/**
 * Create NewComerEventIcon
 * @returns {_ccs.NewComerEventIcon}
 */
_ccs.NewComerEventIcon.create = function () {
    return new _ccs.NewComerEventIcon();
};
